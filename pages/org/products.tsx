...
const Products = () => {
    ...
    // loading and setting user products
    ...
    const { data: userProducts, isLoading: isUserProductsLoading } =
        useQuery<IUserProduct>({
            queryKey: [productsClientApi.Keys.UserProduct, userProduct.id],
            ...
            <div className="bg-gray-100 pt-9">
                <div className="flex gap-[4.4rem] px-16 m-auto">
                    ...
                    <div className="grow max-w-[1920px] flex flex-col py-12 mx-auto">
                        <StepsNavbar
                            selectedNode={stepNamesEnum.pioneerMigratorSettler}
                        />
