          ...
          <div className="xl:w-[50%] px-10 py-10 flex items-center">
            <div className="w-[75%] max-w-[1000px] mx-auto flex flex-col gap-[4rem]">
              ...
              <div className="flex flex-col gap-8">
                <h1 className="text-[4rem] text-onyx font-hero-medium leading-[5.75rem]">2-20x Your Growth</h1>
                ...
                {isLoading && (
                  <Spinner message="loading introductory video..." className="items-center text-dark-400" />
                )}
                ...
                <div className="flex justify-between items-center gap-5 w-[90%]">
                  ...
                  />
                  <Link href="/api/download-pdf" target="_blank" download className="flex justify-end">
                  ...
                  <div className="w-[90%] gap-7 flex justify-end">
                    ...
                    >
                      ...
                      <div className="p-2 bg-primary-400 rounded-full border border-gray-200">
                        <FontAwesomeIcon className="w-[1rem] h-[1rem] text-gray-200 rounded-full" icon={faAngleRight} />
                      </div>
                    </div>
                  </div>
                )}
