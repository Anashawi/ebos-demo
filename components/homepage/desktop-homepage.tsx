    ...
    <>
      ...
      >
        ...
        <div className="h-full relative">
          ...
          >
            <p className="text-3xl text-white">Every project is successful</p>
            <p className="italic text-lg">
              Live and on-demand training, virtual reporting, assistance, and
                ...
                style={{
                  ...
                  left:
                    getRelativeXInPixels(
                      getX(t_values[index] + getDelta_T(t_values[index]))
                    ) + "px",
                  top: getY(t_values[index] + getDelta_T(t_values[index])),
                }}
              >
                {session && (
                  <Link
                ...
                {!session && (
                  <span className="text-center  text-secondary-300 hover:text-secondary-300">
                    {node.text}
                  </span>
                )}
              </div>
          ...
          <svg className="home-line absolute bottom-0 w-full h-[52rem]">
            ...
            <path
              ...
              d={`M ${getRelativeXInPixels(
                ...
                curve.p_0.x
              )} 515 L ${getRelativeXInPixels(curve.p_2.x)} 515`}
            ></path>
            <circle
            ...
            <path
              ...
              d={`M ${getRelativeXInPixels(
                getRelativeXInPixels(
                  getX((t_values[2] - t_values[1]) / 2 + t_values[1]) - 20
                )
