...
import { stepTwo } from "../../components/common/openai-chat/openai-transcript";
...
const ProductsContent = ({
    ...
    const [chatGPTMessage, setChatGPTMessage] = useState<string>(stepTwo);
        ...
        useMutation(
            ...
            },
            {
                onMutate: updated => {
                    ...
                    setChatGPTMessage(getCompanyProductMessage(updated));
                },
                onSuccess: updated => {
        ...
        <>
            <Formik
                ...
                onSubmit={async (values, actions) => {
                    ...
                    // TODO: send chatGPT the new products
