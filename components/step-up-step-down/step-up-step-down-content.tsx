...
const StepUpStepDownContent = ({
    ...
    return (
        <section className="form-container">
            ...
            {isAnalysisLoading && (
                <Spinner className="flex items-center px-1 text-2xl" message="Loading customers..." />
            )}
            {!isAnalysisLoading && (
                                ...
                                userAnalysis.above.map((item, index) => (
                                    <li key={index} className="relative xl:w-[69%] flex items-center">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => {
                                                userAnalysis.above = userAnalysis.above.filter(
                                                    (item, i) => index !== i
                                                );
                                ...
                                userAnalysis.customers.map((item, index) => (
                                    <li key={index} className="relative xl:w-[69%] flex items-center">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => {
                                                userAnalysis.customers = userAnalysis.customers.filter(
                                                    (item, i) => index !== i
                                                );
                                                dispatchUserAnalysis((prevValue: IUserAnalysis) => {
                                                    return {
                                ...
                                userAnalysis.below.map((item, index) => (
                                    <li key={index} className="relative xl:w-[69%] flex items-center">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => {
                                                userAnalysis.below = userAnalysis.below.filter(
                                                    (item, i) => index !== i
                                                );
                                                dispatchUserAnalysis((prevValue: IUserAnalysis) => {
                                                    return {
