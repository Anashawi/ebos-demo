...
import { stepThree } from "../../components/common/openai-chat/openai-transcript";
...
const MarketPotentialContent = ({
    ...
    const [chatGPTMessage, setChatGPTMessage] = useState<string>(stepThree);
        ...
        useMutation(
            ...
            },
            {
                onMutate: updated => {
                    ...
                    setChatGPTMessage(getMarketPotentialMessage(updated));
                },
                onSuccess: updated => {
