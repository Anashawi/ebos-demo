...
import { stepSeven } from "../../components/common/openai-chat/openai-transcript";
...
const BlueOceanContent = ({
    ...
    const [chatGPTMessage, setChatGPTMessage] = useState<string>(stepSeven);
        ...
        useMutation(
            ...
            },
            {
                onMutate: updated => {
                    ...
                    setChatGPTMessage(getBlueOceanMessage(updated));
                },
                onSuccess: updated => {
