...
import { stepFive } from "../../components/common/openai-chat/openai-transcript";
        ...
        <>
            ...
            <div className="pill-yellow-50 p-3 mb-5">
                ...
                <h3 className="text-xl text-dark-300">
                    Watch help videos then update your ideas accordingly. Submit
                    for feedback.
                </h3>
            </div>
            ...
            <Chat initialMessage={stepFive}></Chat>
        </>
    );
};
