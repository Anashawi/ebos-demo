...
export interface UserOrganizationsDocument extends mongoose.Document, UserOrganizationsAttrs { }

interface UserOrganizationsModel extends mongoose.Model<UserOrganizationsDocument> {
...
export const UserOrganizations =
   ...
   mongoose.model<UserOrganizationsDocument, UserOrganizationsModel>("UserOrganizations", UserOrganizationsSchema, "userOrganizations");
